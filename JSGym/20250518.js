...
- 関数名はcheckSignalにするといい

❓ 疑問:
- アロー関数を使用しない方がいい場面はあるのか
　1.オブジェクトの中でthisを使いたい場合
  2.newを使ってオブジェクトを作るときのコンストラクタ
  3.arguments(配列風オブジェクト)を使いたい場合
----------------------------------------
*/
...
- 関数名はcontainsNumberにするとよい
- アロー関数を使い、一行で関数を記述する場合はreturn文を記述する必要はない
----------------------------------------
*/
